        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-4 bg-[#FBF8F3] rounded-3xl border-2 border-[#C5A059]/40 p-6 sm:p-8 shadow-xl text-center flex flex-col justify-between h-full">
            ...
            <div>
              ...
              <div className="qr-surface relative my-6 inline-block p-4 rounded-2xl bg-white border-2 border-[#C5A059]/50 shadow-md">
                
                {/* SVG LINE QR Code */}
                <div className="qr-surface w-44 h-44 sm:w-48 sm:h-48 relative flex items-center justify-center bg-white p-2">
