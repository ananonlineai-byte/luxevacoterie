  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-xs animate-in fade-in duration-200">
      <div className="bg-[#FBF8F3] max-w-md w-full rounded-3xl border-2 border-[#C5A059] p-6 sm:p-8 shadow-2xl relative text-center">
        ...
        {/* QR Code Container */}
        <div className="qr-surface my-6 p-4 rounded-2xl bg-white border-2 border-[#C5A059]/50 shadow-md inline-block">
          <div className="qr-surface w-48 h-48 sm:w-52 sm:h-52 relative flex items-center justify-center bg-white p-2">
